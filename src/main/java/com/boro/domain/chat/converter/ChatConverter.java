...
public class ChatConverter {
    ...
    public static ChatResponseDTO.ChatMessageList toChatMessageList(ChatRoom chatRoom, List<ChatMessage> chatMessageList){
    ...
    public static ChatResponseDTO.ChatRoomPreview toChatRoomDTO(ChatRoom chatRoom){
        return ChatResponseDTO.ChatRoomPreview.builder()
    ...
    public static ChatResponseDTO.ChatRoomList toChatRoomList(ChatRoomType chatRoomType, List<ChatRoom> chatRoomList){
        List<ChatResponseDTO.ChatRoomPreview> chatRooms = chatRoomList.stream()
