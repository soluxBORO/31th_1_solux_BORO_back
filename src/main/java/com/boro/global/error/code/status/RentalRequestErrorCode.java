...
public enum RentalRequestErrorCode implements BaseErrorCode {
    ...
    REVIEW_NOT_ALLOWED_FOR_UNAPPROVED_RENTAL(HttpStatus.BAD_REQUEST, "RENTAL400_5", "승인된 대여 요청에 대해서만 리뷰를 작성할 수 있습니다."),
    RENTAL_RETURN_NOT_COMPLETED(HttpStatus.BAD_REQUEST, "RENTAL400_6", "대여자가 반납한 경우에만 대여 확인이 가능합니다."),
